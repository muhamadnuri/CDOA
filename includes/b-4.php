...
<h1 class="fw-semibold text-center fs-3">مە ناوشار</h1>
...
if(isset($_POST['update']) && isset($admin)){
    ...
    $query = mysqli_query ($db ," UPDATE `bin-3` SET `price`='$price' , `name`='$name' , `date`='$date', `type`='$type' , `note`='$note' WHERE `id`='$id'  ");
    if($query){
