...
<h1 class="fw-semibold text-center fs-3">مەسروفاتی ئالیات</h1>
<div class="btn-group justify-content-end float-end" role="group" aria-label="Basic radio toggle button group">
 

  <input type="radio" class="btn-check " name="btnradio" id="btnradio2" autocomplete="off" checked>
  <label class="btn btn-outline-dark anone" for="btnradio2">مەسروفاتی ئالیات</label>
...
<div class="btn-group me-4 anone" role="group" aria-label="Basic example">
   ...
   <a type="button" class="btn btn-light" href="deleteA.php"><i class="bi bi-trash3-fill"></i></a>
  <a type="button" class="btn btn-light" href="updateA.php"><i class="bi bi-pencil-square"></i></a>
  <a type="button" class="btn btn-light" href="insertA.php"><i class="bi bi-plus-square-fill"></i></a>
   </div>
...
$query = mysqli_query ($db ,"SELECT * FROM `aliat` ORDER BY `id` ASC");
