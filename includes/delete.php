...
if(isset($_GET['delete']) && isset($admin)){
    ...
    $qury=mysqli_query($db ,"DELETE FROM `GSHTI` WHERE `id`='$id'");
if($qury){
...
<a  class="btn btn-outline-dark" href="masrwfG.php" for="btnradio2">مەسروفاتی گشتی</a>
...
while ($row=mysqli_fetch_assoc($query)){?>
  ...
  <tbody>
    <tr class="text-end  " style=" max-width: 60px;">
      ...
      <a type="button" class="btn btn-danger col-1" href="delete.php?delete=<?php echo $row['id'];?>"><i class="bi bi-trash3-fill"></i></a>
    </tr>
