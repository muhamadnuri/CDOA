...
if(isset($_GET['delete']) && isset($admin)){
    ...
    $qury=mysqli_query($db ,"DELETE FROM `aliat` WHERE `id`='$id'");
if($qury){
  echo "<script> window.location.href='deleteA.php';</script>";
}
}
...
while ($row=mysqli_fetch_assoc($query)){?>
  ...
  <tbody>
    <tr class="text-end  " style=" max-width: 60px;">
      ...
      <a type="button" class="btn btn-danger col-1" href="deleteA.php?delete=<?php echo $row['id'];?>"><i class="bi bi-trash3-fill"></i></a>
    </tr>
